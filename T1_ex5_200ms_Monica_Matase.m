...
x(8 : 15) = -A * sin(t(8 : 15) * 2 * pi / T);

x(16 : 22) =  A * sin(t(16 : 22) * 2 * pi / T);
x(23 : 30) = -A * sin(t(23 : 30) * 2 * pi / T);

x(31 : 37) =  A * sin(t(31 : 37) * 2 * pi / T);
x(38 : 45) = -A * sin(t(38 : 45) * 2 * pi / T);
...
figure(1);
title('Semnal sinusoidal redresat de dubla alternanta, subpunctul 3, 200ms');
